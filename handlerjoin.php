<html>
    ...
    <?php
        ...
        function printResult($result) {
            echo "<br>The emails of applicants that have applied for this job:<br>";
            echo "<table>";
            echo "<tr><th>Applicants' emails</th></tr>";
        ...
        function handleJOINRequest() {
            ...
            $result = executePlainSQL("SELECT email FROM Applications_Completes, Applications_For WHERE Applications_Completes.appID = Applications_For.appID AND Applications_For.jobID ='" . $jobID . "'");
            echo printResult($result);
            OCICommit($db_conn);
        }
