<html>
    ...
    <?php
        ...
        function handleNestRequest() {
            ...
            $result = executePlainSQL("SELECT jobID, COUNT(*) FROM Applications_For WHERE jobID IN (SELECT jobID FROM Jobs_Posts WHERE postDate = (SELECT MAX(postDate) FROM Jobs_Posts)) GROUP BY jobID");
